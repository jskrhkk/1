...
class Main_Window():
    def __init__(self):
        ...
        self.ref_menu.add_command(label="Название")
        self.ref_menu.add_command(label="Виды инструментов")
        self.ref_menu.add_command(label="Цена")

        self.book_menu.add_command(label='Поступление музыкальных инструментов')
        self.book_menu.add_command(label='Список музыкальных инструментов')
...
class Provider_Window():
    ...
    def __init__(self):
        ...
        # таблица
        self.table_pr = ttk.Treeview(self.table_frame, columns=('name_provider', 'address', 'contacts'),
